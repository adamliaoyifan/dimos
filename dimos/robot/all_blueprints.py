...
all_blueprints = {
    ...
    "navdp-blueprint": "dimos.navigation.navdp.blueprint:navdp_blueprint",
    ...
    "unitree-go2-vln": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_vln:unitree_go2_vln",
    "unitree-go2-vln-local": "dimos.robot.unitree.go2.blueprints.agentic.unitree_go2_vln_local:unitree_go2_vln_local",
...
all_modules = {
    ...
    "escape-skill-container": "dimos.agents.skills.escape_skill",
    ...
    "nav-dp-memory": "dimos.navigation.navdp.memory",
    "nav-dp-navigator": "dimos.navigation.navdp.navigator",
    "nav-dp-skill-container": "dimos.navigation.navdp.skills",
    ...
    "vln-skill-container": "dimos.agents.skills.vln_skill",
    "vln-web-input": "dimos.agents.skills.vln_web_input",
